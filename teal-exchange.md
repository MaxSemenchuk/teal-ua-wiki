...
* Есть доска объявлений. На ней можно открыть позицию на желаемое время \(1 или несколько дней например\) и указать какие компетенции нужны \(например PR\)
* Люди из коммьюнити откликаются и проходят собеседования на котором выясняют полезность друг другу
